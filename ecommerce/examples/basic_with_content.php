...
if(isset($_POST['action'])){
	...
	$sql1 = "INSERT INTO `eco2` (`id`,`content`) VALUES ('','".$content."')";
	$id = $_GET['id'];
				...
				<nav>
					<ul>
						...
						<li><a href="view.php?id=<?php
								$sql3=mysqli_query($conn,"SELECT * FROM eco2 ORDER BY id DESC LIMIT 1");
						 ...
						 <div class="col-sm-12" data-type="container-content">
                                <section data-type="component-text">
                                    <div class="page-header">
                                        <h1><b class="text-uppercase">Footware Shop</b>
                                        </h1>
							...
							<div class="col-sm-12" data-type="container-content">
                                <section data-type="component-photo">
                                    <div class="photo-panel">
                                        <img src="foot.jpg" style="display: inline-block;" height="" width="100%">
                                    </div>
                                </section>
                            </div>
